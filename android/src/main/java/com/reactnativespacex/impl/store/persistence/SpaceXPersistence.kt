package com.reactnativespacex.impl.store.persistence

import android.content.Context
import android.util.Log
import com.reactnativespacex.impl.store.Record
import com.reactnativespacex.impl.store.RecordSet
...
class SpaceXPersistence(val context: Context, val name: String?) {
    ...
    private val persistenceProvider = EmptyPersistenceProvider()
