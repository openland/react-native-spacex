...
import com.reactnativespacex.impl.store.QueryReadAndWatchResult
import com.reactnativespacex.impl.store.QueryReadResult
import com.reactnativespacex.impl.store.SpaceXStore
import com.reactnativespacex.impl.transport.TransportOperationResult
import com.reactnativespacex.impl.transport.SpaceXTransport
import com.reactnativespacex.impl.transport.TransportState
...
enum class SpaceXMode {
  TRANSPORT_WS, OPENLAND
}

class SpaceXClient(url: String, mode: SpaceXMode, params: Map<String, String>, context: Context, name: String?) {
  private var isConnected = false
  private val store = SpaceXStore(context, name)
  private val transport = SpaceXTransport(TransportState(context, url, mode, params) {
    isConnected = it
