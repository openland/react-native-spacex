package com.reactnativespacex.impl.transport.net
...
class ThrustedSocket {
  ...
  constructor(url: String, protocol: String?, timeout: Int, queue: DispatchQueue) {
    this.url = url
    this.timeout = timeout
    this.queue = queue

    this.thruster = Thruster(CONNECTION_BUCKETS.map { ThrusterConfig(url, it) }.toTypedArray(), protocol, this.queue, this::onConnected)
  }
