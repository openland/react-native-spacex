...
public protocol SpaceXOperations: AnyObject {
...
public class SpaceXOperationDescriptor: SpaceXOperations {
  ...
  public func operationByName(_ name: String) -> OperationDefinition {
